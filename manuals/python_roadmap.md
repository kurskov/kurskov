...
## Приложение А. Полезные библиотеки.

- [ ] [NumPy - фундаментальный пакет для научных вычислений в Python.](https://numpy.org/doc/stable/index.html)
- [ ] [Matplotlib - обширная библиотека для создания статических, анимированных и интерактивных визуализаций на Python.](https://matplotlib.org/stable/index.html)
